<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-6 text-gray-500">
        Questa è la dashboard del tuo sito. Qui potrai aggiungere, rimuovere o modificare il contenuto
        della tua pagina oltre che gestire il tuo profilo.
    </div>
</div>
...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        <div class="flex items-center">
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a target="_blank" href={{ route('add-post') }} >Aggiungi post</a></div>
        </div>
    </div>
